    ...
    elseif ($_POST["title"] != '') {
      ...
      while ($row1 = mysqli_fetch_array($result1)) {
        ...
        while ($row2 = mysqli_fetch_array($result2)) {
          ...
          $query3 = "SELECT *, SUM(Score) FROM criconcat JOIN contestantcategory ON contestantcategory.ContestantCategoryID = criconcat.ContestantCategoryID WHERE ContestantID = ".$contestant." AND CategoryID = ".$category."";
      ...
      $query5 = "SELECT *, SUM(Score) FROM tabulate JOIN contestant ON contestant.ContestantID=tabulate.ContestantID GROUP BY ContestantName ORDER BY SUM(Score) DESC";
